      ...
      <div className="px-4 py-6">
        ...
        <nav className="mt-8">
          <button
            ...
            className="flex items-center mt-4 py-2 px-6 bg-[#0A2439] rounded-md w-full text-left"
          >
            <GaugeIcon className="h-6 w-6" />
            <span className="ml-3">Dashboard</span>
          </button>
          <button
            onClick={() => onSelect("RegisterForNewLicense")}
            className="flex items-center mt-4 py-2 px-6 hover:bg-[#0A2439] rounded-md w-full text-left"
          >
            <ClipboardListIcon className="h-6 w-6" />
            <span className="ml-3">Register for License</span>
          </button>
          <button
            onClick={() => onSelect("RenewLicense")}
            className="flex items-center mt-4 py-2 px-6 hover:bg-[#0A2439] rounded-md w-full text-left"
          >
            <ClipboardListIcon className="h-6 w-6" />
          ...
          <button
            onClick={() => onSelect("ApplicationStatus")}
            className="flex items-center mt-4 py-2 px-6 hover:bg-[#0A2439] rounded-md w-full text-left"
          >
            <ClipboardListIcon className="h-6 w-6" />
            <span className="ml-3"> ApplicationStatus</span>
          </button>
          ...
          <button
            onClick={() => onSelect("DrivingSchools")}
            className="flex items-center mt-4 py-2 px-6 hover:bg-[#0A2439] rounded-md w-full text-left"
          >
