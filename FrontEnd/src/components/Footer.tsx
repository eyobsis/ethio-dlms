...
export default function Footer() {
    return (
        <footer className="bg-[#1E293B] py-10 text-white mt-50">
            <div className="container mx-auto flex flex-col items-center justify-center space-y-8 px-4 md:px-6">
                <div className="flex flex-col items-center space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                    <h4 className="text-2xl font-bold">
                        Welcome to Ethio dlms: Your Ultimate Destination for
                        registering and renewal for drivers licenses in Ethiopia.
                    </h4>
                    <br></br>
                    <p className="max-w-[700px] text-center text-sm md:text-base">
                        ethio dlmsl, 10000, Addis Ababa, Ethiopia
                    </p>
                </div>
                <div className="flex flex-col items-center space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                    <Link
                ...
                <div className="flex flex-col items-center space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <p className="text-sm">+251-12345678</p>
                    </div>
                    <div className="flex items-center space-x-2">
                        <MailIcon className="h-6 w-6 text-[#0EA5E9]" />
                        <p className="text-sm">info@ethiodlms.com</p>
                    </div>
                </div>
                <p className="text-sm text-[#0EA5E9]">
                    © 2024 Ethio-Dlms. All rights reserved.
                </p>
            </div>
        </footer>
    );
