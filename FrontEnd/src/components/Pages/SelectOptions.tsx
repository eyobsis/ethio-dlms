        ...
        <main className="container mx-auto my-12 grid gap-8 px-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <CardContent>
                <p className="text-gray-400">
                  Renew your driver's license quickly and conveniently. Our
                  online process makes it easy to update your information and
          ...
          <Card className="flex flex-col justify-between rounded-lg bg-gray-950 shadow-md dark:bg-gray-950 dark:text-gray-50">
            <div>
              ...
              <CardContent>
                <p className="text-gray-400">
                  Get started on your driving journey by registering as a new
                  student. Our team will guide you through the process and help
          ...
          <Card className="flex flex-col justify-between rounded-lg bg-gray-950 shadow-md dark:bg-gray-950 dark:text-gray-50">
            <div>
              ...
              <CardContent>
                <p className="text-gray-400">
                  Register your vehicle with the state and get your official
                  registration documents. Our streamlined process makes it easy
                  to get your car on the road.
                </p>
              </CardContent>
            </div>
            <CardFooter>
          ...
          <Card className="flex flex-col justify-between rounded-lg bg-gray-950 shadow-md dark:bg-gray-950 dark:text-gray-50">
            <div>
              <CardHeader>
                <CardTitle className="text-white">Driving Lessons</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400">
                  Improve your driving skills with our expert instructors.
                  Whether you're a beginner or looking to sharpen your skills,
                  we offer comprehensive driving lessons to meet your needs.
                </p>
              </CardContent>
            </div>
            <CardFooter>
